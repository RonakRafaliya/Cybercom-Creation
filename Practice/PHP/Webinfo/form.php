            ...
            <div class="container-fliud">
                ...
                <div class="form-row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="text" class="form-control" name="uname" placeholder="Username" require>
                    </div>
                    <div class="col-lg-4">
                    <label for="">Email</label>
                        <input type="email" class="form-control" placeholder="name@example.com" name="uemail" 
                        pattern="[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Please Enter Email in Correct Format" required>
                    </div>
                    <div class="col-lg-2"></div>
                </div>
                <br>
