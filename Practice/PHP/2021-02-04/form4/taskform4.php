...
<body>
  <form action="taskform4.php" name="uForm" method="post" onsubmit="return validation()">
	  <center>
      <h1>Contact Us</h1>
      <input type="text" name="uname" id="uname" placeholder="Name....."><br>
      <span id="uname_e"></span><br>
      <input type="email" name="uemail" id="uemail" placeholder="Email....."><br>
      <span id="uemail_e"></span><br>
      <input type="text" name="usubject" id="usubject" placeholder="Subject....."><br>
      <span id="usubject_e"></span><br>
      <textarea name="umsg" id="umsg" rows="5" cols="20"></textarea><br>
      <span id="umsg_e"></span><br>
