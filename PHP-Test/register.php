    ...
    <form action="register.php" method="POST" class="needs-validation" novalidate>
        ...
        <div class="form-row">
            ...
            <div class="col-lg-4">
                ...
                <input type="email" class="form-control" placeholder="name@example.com" name="email" pattern="[a-zA-Z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Please Enter Email in Correct Format" required>
                <div class="valid-feedback">Valid.</div>
                <div class="invalid-feedback">Please fill out this field.</div>
            </div>
            <div class="col-lg-4"></div>
